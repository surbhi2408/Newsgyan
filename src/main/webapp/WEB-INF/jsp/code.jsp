        ...
        <div class="col-4">
            <div class="p-5 mb-5 bg-white shadow" style="margin: 90px 0px;">
                <div class="m-5">
                    ...
                    <h1 class="text-info text-center pt-4 pb-4" style="font-family: 'Times New Roman'; font-size: 25px"><b>please enter verification code</b></h1>
                    <form action="submitcode" method="post">
                        <input type="text" name="code" placeholder="code" class="form-control mb-4">
