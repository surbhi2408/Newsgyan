...
<div class="jumbotron-fluid">
    ...
    <div class="jumbotron-fluid">
        <img src="${pageContext.servletContext.contextPath}/images/fashion.jpg" class="card-img img-fluid img-responsive" style="height: 800px;width: 100%;background-size: cover;opacity: 0.7;">
        <img src="${pageContext.servletContext.contextPath}/images/user/${ud.image}" class="rounded-circle" style="height: 300px;width: 300px;margin-top: -100px;margin-left: 150px;position: relative;">
    </div>
</div>
