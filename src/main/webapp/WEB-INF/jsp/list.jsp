...
<div class="jumbotron-fluid">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4 bg-dark" style="height: 100%; width: 300px;position: fixed;">
        <div class="sidebar" id="ver">
            <nav class="pt-3">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="/news" class="nav-link">Add News</a>
                    </li>
                    <li class="nav-item">
        ...
        <table>
            ...
            <c:forEach items="${list}" var="x">
                <tr>
                    <td>${x.id}</td>
                    <td>${x.username}</td>
                    <td><a href="accept?username=${x.username}">ACCEPT</a> || <a href="delete?id=${x.id}">DECLINE</a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
