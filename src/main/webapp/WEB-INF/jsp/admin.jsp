...
<head>
    ...
    <title>login form for admin in NEWSGyan</title>
    <style type="text/css">
        .form-control{
            font-size: 20px;
        }
        ...
        <div class="col-4">
            <div class="p-5 mb-5 bg-white shadow" style="margin: 90px 0px;">
                <div class="m-5">
                    ...
                    <h1 class="text-info text-center pt-4 pb-4" style="font-family: 'Times New Roman'; font-size: 35px"><b>Login</b></h1>
                    <form action="adminlogin" method="post">
                        <input type="text" name="username" placeholder="username" class="form-control mb-4">
                        <input type="password" name="password" placeholder="password" class="form-control mb-4"><br>
